...
public class Mesh {
	...
	public void setVertices(Vertex3D[] vertices, int[] indices) {
	...
	public void draw() {		
		...
		gl.glBindBuffer(GL_ARRAY_BUFFER, vbos[0]);
		gl.glVertexAttribPointer(0, 3, GL_FLOAT, false, Vertex3D.SIZE*4, 0);
		gl.glVertexAttribPointer(1, 2, GL_FLOAT, false, Vertex3D.SIZE*4, 12);
